...
@pytest.fixture
def api_token(http_s, url_call):
    call = session.post(f'{http_s}://{url_call}/index.php?route=api/login',
...
def test_api_login(http_s, url_call):
    call = session.post(f'{http_s}://{url_call}/index.php?route=api/login',
                        data={'username': 'user_tests', 'key': key})
...
def test_api_shipping_address(api_token, http_s, url_call):
    call = session.post(f'{http_s}://{url_call}/index.php?route=api/shipping/address',
...
def test_api_currency(api_token, http_s, url_call, valute):
    call = session.post(f'{http_s}://{url_call}/index.php?route=api/currency',
...
def test_api_incorrect_currency(api_token, http_s, url_call):
    call = session.post(f'{http_s}://{url_call}/index.php?route=api/currency',
...
def test_api_cart_add(api_token, http_s, url_call):
    call = session.post(f'{http_s}://{url_call}/index.php?route=api/cart/add',
...
def test_api_cart_add_non_existent(api_token, http_s, url_call):
    call = session.post(f'{http_s}://{url_call}/index.php?route=api/cart/add',
...
def test_api_cart_add_negative_quantuty(api_token, http_s, url_call):
...
def test_api_add_cart_edit(api_token, http_s, url_call):
    call = session.post(f'{http_s}://{url_call}/index.php?route=api/cart/edit',
...
def test_api_add_cart_edit(api_token, http_s, url_call):
    call = session.post(f'{http_s}://{url_call}/index.php?route=api/cart/remove',
...
def test_api_add_cart_products(api_token, http_s, url_call):
    call = session.post(f'{http_s}://{url_call}/index.php?route=api/cart/products',
...
def test_api_coupons_valid(api_token, http_s, url_call):
    call = session.post(f'{http_s}://{url_call}/index.php?route=api/coupon',
...
def test_api_customers_valid(api_token, http_s, url_call):
    call = session.post(f'{http_s}://{url_call}/index.php?route=api/customer',
...
def test_api_customers_invalid(api_token, http_s, url_call):
    call = session.post(f'{http_s}://{url_call}/index.php?route=api/customer',
                        params={'api_token': api_token}, data={})
    result = dict(json.loads(call.text))
...
def test_api_voucher_valid(api_token, http_s, url_call):
    call = session.post(f'{http_s}://{url_call}/index.php?route=api/voucher',
...
def test_api_voucher_invalid(api_token, http_s, url_call):
    call = session.post(f'{http_s}://{url_call}/index.php?route=api/voucher',
...
def test_api_voucher_add(api_token, http_s, url_call):
    call = session.post(f'{http_s}://{url_call}/index.php?route=api/voucher/add',
...
def test_api_invalid_voucher_add(api_token, http_s, url_call):
    call = session.post(f'{http_s}://{url_call}/index.php?route=api/voucher/add',
                        params={'api_token': api_token}, data={})
    result = dict(json.loads(call.text))
...
def test_api_shipping_methods(api_token, http_s, url_call):
    call = session.post(f'{http_s}://{url_call}/index.php?route=api/shipping/methods',
...
def test_api_shipping_method(api_token, http_s, url_call):
    call = session.post(f'{http_s}://{url_call}/index.php?route=api/shipping/method',
...
def test_api_reward_maximum(api_token, http_s, url_call):
    call = session.post(f'{http_s}://{url_call}/index.php?route=api/reward/maximum',
                        params={'api_token': api_token}, data={})
...
def test_api_payment_address(api_token, http_s, url_call):
    call = session.post(f'{http_s}://{url_call}/index.php?route=api/payment/address',
                        params={'api_token': api_token}, data={'firstname': 'Customer',
                                                               'lastname': 'Dear',
                                                               'address_1': 'Somewhere',
                                                               'city': 'KLD',
